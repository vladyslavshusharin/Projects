...
<head>
    ...
    <title>FineJob - Napsat hodnocení firmy</title>
</head>
<body>
 ...
 <div class="site">
  ...
  <h1 class="oswald-Cfont">Napsat hodnocení firmy</h1>

  <form action="hodnoceni_firmy_handle.php" class="box-vertical" method="POST">
