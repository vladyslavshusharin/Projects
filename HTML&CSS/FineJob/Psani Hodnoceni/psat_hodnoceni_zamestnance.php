...
<head>
    ...
    <title>FineJob - Napsat hodnocení zaměstnance</title>
</head>
<body>
 ...
 <div class="site">
  ...
  <h1 class="oswald-Cfont">Napsat hodnocení zaměstnance</h1>

  <form action="hodnoceni_zamestnance_handle.php" class="box-vertical" method="POST">
