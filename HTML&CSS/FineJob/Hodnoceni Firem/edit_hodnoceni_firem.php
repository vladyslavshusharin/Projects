...
<head>
    ...
    <title>FineJob - Editovat hodnocení firmy</title>
</head>
<body>
 ...
 <div class="site">
  ...
  <form action="edit_hodnoceni_firem_handle.php" class="box-vertical" method="POST">
      ...
      <div class="box-horizontal Bmargin-0p25">
       ...
       <label class="box-horizontal bg-color-gray">
        <?php if(isset($HODNOCENI_DATA['Anonym']) && $HODNOCENI_DATA['Anonym'] == 1):?>
        <input type="checkbox" name="AnonymTag" id="AnonymTag" value="1" checked>
        <?php else:?>
        <input type="checkbox" name="AnonymTag" id="AnonymTag" value="1">
        <?php endif;?>
        <p>Anonymní hodnocení?</p>
       </label>
