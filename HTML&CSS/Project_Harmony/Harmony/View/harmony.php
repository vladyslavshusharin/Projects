...
<main>
 ...
 <div class="bigbox-horizontal null-padding align-center border-trans bg-color-Lblack Bmargin-0p1">
    ...
    <div class="box-horizontal null-padding stick-to-right text-full-center border-trans">
     ...
     <button class="Lpadding-0p1 box-rounded Rpadding-0p1 bg-color-black box-horizontal text-full-center Rmargin-0p1 oswald-font text-pageread" onclick="stopMessages()" type="button" id="profile">
     <p class="text-color-yellow text-pageread"><?php echo $_SESSION['nickname']?></p>
     </button>
    </div>
 </div>
